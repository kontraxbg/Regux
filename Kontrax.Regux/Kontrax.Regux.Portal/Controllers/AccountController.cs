...
{
    [Audit(AuditingLevel = AuditingLevelEnum.All)]
    [Authorize]
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    using (var _auditService = new AuditService())
                    {
                        await _auditService.EditActivityAsync(AuditId, $"Неуспешен вход на {model.Email}");
                    };
                    return View(model);
            }
        }
